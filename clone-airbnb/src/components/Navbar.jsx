            ...
            <nav className='nav-topo'>
                <div className='m-auto container-airbnb'>
                    ...
                    <div className='d-flex justify-content-end col-sm-6'>
                        ...
                        <div className="dropdown d-flex align-itens-center">
                            <a className="btn-login" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi bi-list fs-5 ps-2 me-1"></i>
                                <i class="bi bi-person-circle position-relative fs-2 pe-2"><span class="position-absolute top-0 start-50 badge border border-light rounded-circle bg-danger p-2"><span class="visually-hidden">unread messages</span></span></i>
                            </a>
